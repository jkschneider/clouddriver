...
package com.netflix.spinnaker.clouddriver.cloudfoundry.configuration
...
class CloudFoundryConfiguration {
  ...
  @Bean
  @ConditionalOnMissingBean(CloudFoundryCLIOperatorFactory)
  CloudFoundryCLIOperatorFactory cliOperatorFactory() {
    new DefaultCloudFoundryCLIOperatorFactory()
  }
}
